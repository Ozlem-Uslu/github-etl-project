...
verbindet sich mit der GitHub REST API
sucht nach populären GitHub-Repositories
extrahiert Repository-Metadaten
transformiert rohe JSON-Daten in strukturierte Tabellen
speichert die bereinigten Daten als CSV-Datei
